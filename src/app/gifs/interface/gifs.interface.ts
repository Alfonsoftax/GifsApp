...
export enum Description {
    EligeTodo = "Elige todo.",
    RealBetisBalompiéOfficialGiphyAccount = "Real Betis Balompié Official Giphy account",
}
...
export enum Username {
    ...
    RealBetisBalompie = "RealBetisBalompie",
}
...
const typeMap: any = {
    ...
    "Description": [
        "Elige todo.",
        "Real Betis Balompié Official Giphy account",
    ],
    "DisplayName": [
        "Movistar+",
        "Real Betis Balompié",
